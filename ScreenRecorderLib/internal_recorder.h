...
private:
	...
	HRESULT InitializeVideoSinkWriter(std::wstring path, ID3D11Device* pDevice, RECT sourceRect, RECT destRect, IMFSinkWriter **ppWriter, DWORD *pVideoStreamIndex, DWORD *pAudioStreamIndex);
