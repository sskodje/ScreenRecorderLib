...
namespace ScreenRecorderLib::Overlays {
	...
	public:
		...
		virtual HRESULT StartCapture(HANDLE sharedCanvasHandle, _In_ std::vector<RECORDING_OVERLAY> overlays, _In_  HANDLE hUnexpectedErrorEvent, _In_  HANDLE hExpectedErrorEvent);
