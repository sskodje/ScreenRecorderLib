...
private:
	...
	HRESULT DrawMousePointer(ID3D11Texture2D *frame, mouse_pointer *pointer, PTR_INFO ptrInfo, DXGI_MODE_ROTATION screenRotation, INT64 durationSinceLastFrame100Nanos);
