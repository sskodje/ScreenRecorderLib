...
public:
	...
	HRESULT CreateTextureFromBuffer(_In_ BYTE *PtrFrameBuffer, _In_ LONG stride, _In_ UINT width, _In_ UINT height, _Outptr_ ID3D11Texture2D **ppTexture, std::optional<D3D11_RESOURCE_MISC_FLAG> miscFlag = std::nullopt);
private:
	//HRESULT InitShaders();
